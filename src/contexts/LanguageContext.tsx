...
const translations: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    "consult.elapsed": "Tempo de orientação técnica",
    ...
    "a11y.videoArea": "Área de vídeo da teleorientação técnica",
  ...
  en: {
    ...
    "common.yes": "Yes",
    "common.no": "No",
    "consult.title": "Teleorientação técnication",
    "consult.mute": "Mute",
    ...
    "a11y.videoArea": "Teleorientação técnication video area",
  ...
  es: {
    ...
    "consult.elapsed": "Tiempo de orientação técnica",
    "consult.waitingRoom": "Sala de Espera Virtual",
    ...
    "a11y.videoArea": "Área de video de teleorientação técnica",
    "a11y.chatArea": "Área de chat",
  },
};
