...
const plans = [
  {
    ...
    name: "Essencial",
    price: 50,
    features: ["Acesso à plataforma", "1 orientação técnica/mês", "Suporte por chat"],
  ...
  },
  {
    ...
    price: 100,
    features: ["Tudo do Essencial", "3 orientação técnicas/mês", "Clube de descontos", "Suporte prioritário"],
  ...
  },
  {
    ...
    name: "Família",
    price: 250,
    features: ["Tudo do Acesso", "Até 5 dependentes", "Orientação Técnicas ilimitadas", "Prescrição digital"],
    color: "hsl(45,76%,52%)",
    popular: false,
  },
  {
