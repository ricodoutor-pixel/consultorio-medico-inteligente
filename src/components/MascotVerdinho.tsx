...
export default function MascotVerdinho({ onChatOpen, className = "", inline = false }: MascotVerdinhoProps) {
  ...
  return (
    <>
      ...
      >
        <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-full bg-card/70 backdrop-blur-md shadow-md ring-1 ring-emerald-500/25 hover:ring-emerald-400/40 transition">
