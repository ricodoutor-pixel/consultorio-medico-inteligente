...
const FluxoAtendimento = lazyWithRecovery(() => import("./pages/FluxoAtendimento"), { sourceRef: "/atendimento" });
...
const AdminImportacoesAnvisa = lazyWithRecovery(() => import("./pages/admin/AdminImportacoesAnvisa"), { sourceRef: "/admin/importacoes-anvisa" });
          ...
          <BrowserRouter>
            ...
            <Suspense fallback={<Loading />}>
              ...
              <Route path="/dashboard-medico" element={<PrivateRoute><DashboardMedico /></PrivateRoute>} />
                ...
                <Route path="/atendimento" element={<FluxoAtendimento />} />
