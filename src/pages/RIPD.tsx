...
const sections = [
  ...
  },
  {
    ...
    icon: Database,
    content: [
      "Finalidade: Prestação de serviços de telemedicina em cannabis medicinal, incluindo agendamento de orientação técnicas, teleorientação técnicas (vídeo/chat), emissão de prescrições digitais, e gestão de prontuários eletrônicos.",
  ...
  },
  {
    ...
    content: [
      ...
      "Dados sensíveis de saúde são tratados sob consentimento explícito (TCLE digital) assinado antes de cada teleorientação técnica.",
  ...
  },
  {
    ...
    content: [
      ...
      "Teleorientação técnica: Vídeo via WebRTC (Jitsi) sem gravação por padrão (Art. 7º, CFM 2.314/2022). Chat criptografado E2E.",
  ...
  },
  {
    ...
    risks: [
      ...
      { risk: "Interceptação de teleorientação técnica", mitigation: "WebRTC com SRTP + TLS 1.3 + sem gravação padrão", severity: "Alto" },
