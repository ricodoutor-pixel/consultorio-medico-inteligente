        ...
        <div className="border-t border-border mt-8 pt-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 mb-6">
            <a
              ...
              className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 hover:border-primary/40 hover:shadow-md transition-all duration-300 group"
              title="Lei Geral de Proteção de Dados"
            >
              <Shield size={20} className="text-primary group-hover:scale-110 transition-transform" />
              <div className="text-left">
                <span className="block text-xs font-bold text-foreground leading-tight">LGPD</span>
                <span className="block text-[10px] text-muted-foreground leading-tight">Compliant</span>
              </div>
            </a>
            ...
            >
              <svg viewBox="0 0 32 32" className="w-5 h-5 text-primary group-hover:scale-110 transition-transform" fill="none">
              ...
              <div className="text-left">
                <span className="block text-xs font-bold text-foreground leading-tight">ANVISA</span>
                <span className="block text-[10px] text-muted-foreground leading-tight">Regular</span>
              </div>
            </a>
          </div>
          ...
          {/* Social Media & Google */}
          <div className="mb-6">
            <h4 className="text-sm font-semibold text-foreground mb-3">Nossas Redes e Recursos</h4>
            <div className="flex items-center justify-center gap-4">
              <a
                href="https://www.facebook.com/plantayraiz"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full bg-[#1877F2] flex items-center justify-center text-white hover:scale-110 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] flex items-center justify-center text-white hover:scale-110 hover:shadow-lg hover:shadow-pink-500/30 transition-all duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full bg-[#FF0000] flex items-center justify-center text-white hover:scale-110 hover:shadow-lg hover:shadow-red-500/30 transition-all duration-300"
                aria-label="YouTube"
              >
                <Youtube size={20} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full bg-card border border-border flex items-center justify-center hover:scale-110 hover:shadow-lg hover:border-primary/40 transition-all duration-300"
