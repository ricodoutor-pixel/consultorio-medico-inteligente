...
import { ChevronRight, Users, Star, Download, TrendingUp } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="inline-block">
                <span className="px-4 py-2 rounded-full border border-[#00FF00]/30 text-[#00FF00] text-sm font-medium">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <br />
                <span className="text-yellow-400">el Mundo</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button variant="outline" className="border-[#00FF00] text-[#00FF00] hover:bg-[#00FF00]/10 font-bold text-lg px-8 py-6">
                  Abrir Shopping
                </Button>
              </div>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-64 h-96 bg-gradient-to-b from-[#1a1f3a] to-[#0A0E27] rounded-3xl border-8 border-gray-800 shadow-2xl flex items-center justify-center">
                <div className="text-center space-y-4 p-6">
                  ...
                  <h3 className="text-[#00FF00] font-bold text-xl">Planta & Raiz</h3>
                  <p className="text-gray-300 text-sm">Realizar uma consulta</p>
      ...
      <section className="px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24 py-16 sm:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 sm:space-y-6">
            {[
              { q: 'A Planta & Raiz vende "cura"?', a: 'Não. Somos uma plataforma de telemedicina educativa.' },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">(11) 98713-1241</p>
          ...
          <div className="border-t border-[#00FF00]/20 pt-8 text-center text-gray-400 text-sm">
            <p>© 2026 Planta & Raiz. Feito com 💚 para quem mais precisa.</p>
          </div>
        </div>
      </footer>
    </div>
