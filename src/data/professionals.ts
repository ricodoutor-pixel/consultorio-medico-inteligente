...
export const professionals: Professional[] = [
...

  {
    ...
    experience: "10 anos",
    tags: ["Clínica Geral", "Medicina Canabinoide", "Dor Crônica", "Ansiedade"],
    price: "R$ 120,00",
    priceValue: 120,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "555493646065",
    ...
    reviews: [
      ...
      { name: "Carlos R.", rating: 5, text: "Atendimento exemplar, esclareceu todas as minhas dúvidas." },
      { name: "Fernanda M.", rating: 5, text: "Tratamento personalizado que trouxe alívio para minhas dores." },
    ],
  },
  {
    id: "med-4",
