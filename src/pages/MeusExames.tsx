...
const diagnosticToolsMap: Record<string, { title: string; route: string; icon: any }> = {
  cardiaco: { title: "Monitor Cardíaco", route: "/monitoramento", icon: Stethoscope },
  fundoscopia: { title: "Fundo de Olho IA", route: "/monitoramento", icon: Smartphone },
  oximetria: { title: "Oximetria Óptica", route: "/monitoramento", icon: Smartphone },
  ...
  estetoscopio: { title: "Estetoscópio Digital", route: "/monitoramento", icon: Stethoscope },
  ...
  urine: { title: "Urinálise IA", route: "/monitoramento", icon: Smartphone },
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground flex flex-col">
      <header className="p-4 flex items-center gap-3 border-b border-border/40 bg-card/50 sticky top-0 z-10 backdrop-blur-md">
        ...
        <h1 className="text-xl font-display font-black tracking-tight">Hub Médico</h1>
      </header>
      ...
      <main className="flex-1 p-4 md:p-6 max-w-2xl mx-auto w-full flex flex-col gap-6">
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-lg font-black mb-1">Acessar Plataforma Clínica</h3>
            <p className="text-xs text-muted-foreground">Telemedicina, Prontuários e Consultas</p>
          </div>
        ...
        <div className="mt-4">
          <h3 className="font-black text-sm uppercase tracking-wider text-muted-foreground mb-4 pl-2">
            ?? Minhas Ferramentas Diagnósticas
          </h3>
          ...
          {loading ? (
            ...
            <div className="bg-card/40 border border-border/40 rounded-3xl p-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">Você ainda não possui módulos de exame.</p>
