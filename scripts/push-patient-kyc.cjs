...
async function run() {
  const files = [
    'src/lib/patient-kyc-docs.ts',
    'src/components/admin/PatientKycDocViewer.tsx',
    'src/pages/admin/AdminAprovacoesPacientes.tsx',
    'src/pages/admin/AdminAprovacoesFarmacias.tsx',
    'src/pages/admin/AdminAprovacoes.tsx',
    'src/pages/Admin.tsx',
    'src/App.tsx',
  ];

  for (const f of files) {
    await pushFile(f, 'feat: add KYC Pacientes 360 degree module, online presence indicator, and quick access');
  }
}
