...
export const openGraphConfigs: Record<string, OpenGraphConfig> = {
  home: {
    ...
    description: 'Referência no tratamento com cannabis medicinal no Brasil. Orientação Técnicas com especialistas por apenas R$30. Democratizando acesso à medicina personalizada.',
