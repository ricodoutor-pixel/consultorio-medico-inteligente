        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }}>
              <img src={heroImg} alt="Sistema endocanabinoide e tratamento de dor crônica com cannabis medicinal" width={1280} height={720} {...({ fetchpriority: "high" } as Record<string, string>)} className="rounded-2xl shadow-xl border border-primary/10 w-full" />
            </motion.div>
          </div>
        </div>
      </section>
