...
// "Orientação Técnica com Dr. Edilson Bezerra (CRM-CE 10963) On" that Enf. Brisa shares via WhatsApp.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const preference = {
      items: [{
        title: "Orientação Técnica — Dr. Edilson Bezerra (CRM-CE 10963) On",
