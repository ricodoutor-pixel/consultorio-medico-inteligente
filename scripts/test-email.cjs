// Script de teste — envia 1 email para ricodoutor@gmail.com via Brevo API
...
<div style="max-width:680px;margin:30px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.10);">
  <div style="background:linear-gradient(135deg,#0a3d2e 0%,#10b981 100%);padding:40px 30px 36px;text-align:center;">
    ...
    <h1 style="margin:0;font-size:30px;font-weight:900;color:#fff;letter-spacing:3px;text-transform:uppercase;line-height:1.2;">PLANTA Y RAÍZ LTDA</h1>
  ...
  <div style="padding:38px 32px;color:#1e293b;font-size:15px;line-height:1.75;">
    <p style="margin:0 0 16px;">Prezado(a) <strong>Dr. Ricardo</strong>,</p>
    <p>Este é um <strong>email de teste</strong> da campanha de convite para Médico Sócio Prescritor.</p>
    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:22px;">
      <thead><tr style="background:#0a3d2e;color:#fff;">
    ...
    <p><strong>💰 Potencial de até R$ 45.000/mês</strong><br>Atenda 10 pacientes/dia a R$ 150. Retenção de 93%. PIX ao término de cada consulta. Distribuição de lucros por desempenho. Plano de Indicação em 3 gerações.</p>
    <p><strong>🧠 Tecnologia de Ponta</strong><br>Robô de triagem IA, prescritor canábico inteligente com calculadora de dosagem CBD/THC/CYP450, workspace split-pane HD, perfil de visibilidade global.</p>
    <p><strong>🛡️ Compliance & Segurança Jurídica</strong><br>100% conforme CFM, ANVISA e LGPD. Assistência jurídica especializada inclusa.</p>
    <blockquote style="border-left:4px solid #10b981;padding:14px 18px;margin:24px 0;background:#f0fdf4;font-style:italic;color:#065f46;font-size:14px;border-radius:0 8px 8px 0;">"Não seja apenas mais um médico cadastrado em plataformas que valorizam apenas a própria margem. Seja sócio da plataforma que valoriza o seu conhecimento e a sua liberdade clínica."</blockquote>
    ...
    <div style="text-align:center;margin:32px 0;">
      <a href="https://plantayraiz.com.br/cadastro-profissional" style="display:inline-block;background:linear-gradient(135deg,#059669 0%,#10b981 100%);color:#fff;padding:17px 44px;font-size:17px;font-weight:800;text-decoration:none;border-radius:8px;box-shadow:0 4px 16px rgba(16,185,129,0.45);">👉 FAÇA SEU CADASTRO GRATUITO</a>
    </div>
    <p style="text-align:center;font-size:13px;color:#64748b;">WhatsApp: <strong>(11) 99136-3154</strong> | <a href="https://plantayraiz.com.br" style="color:#059669;">plantayraiz.com.br</a></p>
  </div>
  <div style="background:#f1f5f9;border-top:1px solid #e2e8f0;padding:24px 32px;">
    ...
    <p style="margin:0;font-size:11px;color:#94a3b8;text-align:center;">Planta y Raíz Ltda · MEGA CLÍNICA DIGITAL · A Plataforma nº 1 de Telemedicina Canabinoide<br>⚠️ Este é um email de TESTE — não será enviado para os prescritores</p>
  </div>
</div>
</body></html>`;

async function sendTest() {
  console.log('📧 Enviando email de teste para ricodoutor@gmail.com ...');
  ...
  const res = await fetch('https://api.brevo.com/v3/smtp/email', {
    ...
    body: JSON.stringify({
      ...
      to: [{ email: 'ricodoutor@gmail.com', name: 'Dr. Ricardo (TESTE)' }],
  ...
  if (res.ok) {
    ...
    console.log('\n   Por favor, verifique sua caixa de entrada em ricodoutor@gmail.com');
    console.log('   e confirme se o layout está correto antes do disparo geral.');
  } else {
