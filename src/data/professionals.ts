...
export const professionals: Professional[] = [
  ...
  // ═══════ Test Doctors — Cannabis Cannabinoid Medicine (auto fade-out as real doctors register) ═══════
  {
    id: "test-doctor-1",
    name: "Dra. Beatriz Souza",
    category: "Médicos Prescritores",
    bio: "Neurologista com foco em dor crônica e enxaqueca refratária. Abordagem cannabinoide baseada em evidências, atendendo pacientes em São Paulo e remotamente.",
    experience: "11 anos",
    tags: ["Neurologia", "Dor Crônica", "CRM-SP"],
    price: "R$ 120,00",
    priceValue: 120,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 280,
    avatar: "BS",
    imageUrl: testBeatrizImg,
    online: false,
    crm: "CRM-SP 184522",
    flags: ["🇧🇷", "🇺🇸"],
    services: [
      { name: "Consulta Inicial", price: "R$ 120,00", desc: "Avaliação neurológica + plano canábico" },
      { name: "Retorno", price: "R$ 70,00", desc: "Acompanhamento e ajuste" },
    ],
    slots: ["09:00", "10:00", "14:00", "15:00"],
    reviews: [{ name: "Paciente A.", rating: 5, text: "Atenciosa e técnica. Resolveu minha enxaqueca." }],
  },
  {
    id: "test-doctor-2",
    name: "Dr. Mark Evans",
    category: "Médicos Prescritores",
    bio: "Pain management specialist based in Miami. Over a decade of experience prescribing medical cannabis for chronic pain and post-surgical recovery.",
    experience: "13 years",
    tags: ["Pain Management", "Chronic Pain", "MD-FL"],
    price: "$ 90,00",
    priceValue: 90,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 410,
    avatar: "ME",
    imageUrl: testMarkImg,
    online: false,
    crm: "MD-FL 56821",
    flags: ["🇺🇸", "🇪🇸"],
    services: [
      { name: "Initial Consult", price: "$ 90,00", desc: "Full assessment + cannabinoid plan" },
      { name: "Follow-up", price: "$ 50,00", desc: "Dose adjustment" },
    ],
    slots: ["08:00", "11:00", "14:00", "16:00"],
    reviews: [{ name: "Patient J.", rating: 5, text: "Professional and clear treatment plan." }],
  },
  {
    id: "test-doctor-3",
    name: "Dra. Elena Rodriguez",
    category: "Médicos Prescritores",
    bio: "Psiquiatra colegiada en Madrid. Especialista en ansiedad, insomnio y TEPT con cannabis medicinal. Atención bilingüe español/inglés.",
    experience: "9 años",
    tags: ["Psiquiatría", "Ansiedad", "Col. Med. Madrid"],
    price: "€ 85,00",
    priceValue: 85,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 320,
    avatar: "ER",
    imageUrl: testElenaImg,
    online: false,
    crm: "Col. Med. Madrid 280911",
    flags: ["🇪🇸", "🇺🇸"],
    services: [
      { name: "Consulta Inicial", price: "€ 85,00", desc: "Evaluación psiquiátrica + plan cannabinoide" },
      { name: "Seguimiento", price: "€ 50,00", desc: "Ajuste terapéutico" },
    ],
    slots: ["10:00", "12:00", "15:00", "17:00"],
    reviews: [{ name: "Paciente M.", rating: 5, text: "Profesional cercana y eficaz." }],
  },
  {
    id: "test-doctor-4",
    name: "Dr. David Okafor",
    category: "Médicos Prescritores",
    bio: "Senior integrative medicine physician with 25+ years of clinical practice. Specialist in oncologic palliative care using cannabinoid therapies.",
    experience: "26 years",
    tags: ["Medicina Integrativa", "Cuidados Paliativos", "MD"],
    price: "$ 110,00",
    priceValue: 110,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 720,
    avatar: "DO",
    imageUrl: testDavidImg,
    online: false,
    crm: "MD-NY 22980",
    flags: ["🇺🇸", "🇬🇧"],
    services: [
      { name: "Initial Consult", price: "$ 110,00", desc: "Comprehensive integrative assessment" },
      { name: "Follow-up", price: "$ 65,00", desc: "Treatment review" },
    ],
    slots: ["09:00", "11:00", "13:00", "15:00"],
    reviews: [{ name: "Patient R.", rating: 5, text: "A truly experienced and compassionate doctor." }],
  },
  {
    id: "test-doctor-5",
    name: "Dra. Jiwoo Park",
    category: "Médicos Prescritores",
    bio: "Neurologist focused on epilepsy and pediatric refractory seizures. Pioneering cannabinoid protocols in Seoul and consulting internationally.",
    experience: "8 years",
    tags: ["Neurology", "Epilepsy", "MD-KR"],
    price: "$ 95,00",
    priceValue: 95,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 240,
    avatar: "JP",
    imageUrl: testJiwooImg,
    online: false,
    crm: "MD-KR 110923",
    flags: ["🇰🇷", "🇺🇸"],
    services: [
      { name: "Initial Consult", price: "$ 95,00", desc: "Neurological assessment + protocol" },
      { name: "Follow-up", price: "$ 55,00", desc: "Adjustment session" },
    ],
    slots: ["08:00", "10:00", "13:00", "16:00"],
    reviews: [{ name: "Patient S.", rating: 5, text: "Very thorough and kind specialist." }],
  },
  {
    id: "test-doctor-6",
    name: "Dr. Felipe Cardoso",
    category: "Médicos Prescritores",
    bio: "Médico de família com pós-graduação em medicina canábica. Atende em Belo Horizonte com foco em saúde da mulher, fibromialgia e endometriose.",
    experience: "10 anos",
    tags: ["Medicina de Família", "Fibromialgia", "CRM-MG"],
    price: "R$ 100,00",
    priceValue: 100,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 295,
    avatar: "FC",
    imageUrl: testFelipeImg,
    online: false,
    crm: "CRM-MG 71234",
    flags: ["🇧🇷", "🇪🇸"],
    services: [
      { name: "Consulta Inicial", price: "R$ 100,00", desc: "Avaliação integral + plano cannabinoide" },
      { name: "Retorno", price: "R$ 60,00", desc: "Ajuste terapêutico" },
    ],
    slots: ["09:00", "11:00", "14:00", "17:00"],
    reviews: [{ name: "Paciente L.", rating: 5, text: "Médico humano e muito competente." }],
  },
  {
    id: "test-doctor-7",
    name: "Dra. Layla Hassan",
    category: "Médicos Prescritores",
    bio: "Internist and clinical researcher in cannabinoid pharmacology, based in Dubai. Bilingual Arabic/English consultations focused on autoimmune conditions.",
    experience: "12 years",
    tags: ["Medicina Interna", "Autoimmune", "MD-AE"],
    price: "$ 100,00",
    priceValue: 100,
    paymentLink: "https://mpago.la/12KAwmH",
    whatsapp: "5511991363154",
    ...
    consults: 360,
    avatar: "LH",
    imageUrl: testLaylaImg,
    online: false,
    crm: "MD-AE 33421",
    flags: ["🇦🇪", "🇬🇧"],
    services: [
      { name: "Initial Consult", price: "$ 100,00", desc: "Internal medicine + cannabinoid plan" },
      { name: "Follow-up", price: "$ 60,00", desc: "Therapy review" },
    ],
    slots: ["10:00", "12:00", "15:00", "18:00"],
    reviews: [{ name: "Patient K.", rating: 5, text: "Highly knowledgeable and empathetic." }],
  },
];
