REVOKE EXECUTE ON FUNCTION public.get_cron_health(integer) FROM anon, authenticated, public;

CREATE OR REPLACE FUNCTION public.get_cron_health(_window_hours integer DEFAULT NULL)
...
GRANT EXECUTE ON FUNCTION public.get_cron_health(integer) TO authenticated, service_role;