...
const WA_LINK = `https://wa.me/5511991363154?text=${encodeURIComponent(
  "Olá Enfª Brisa, quero garantir minha Orientação Técnica de R$30 com o Dr. Edilson Bezerra On!"
)}`;
...
function inviteMessage(nome: string, categoria: string | null) {
  ...
  return (
    `Olá ${first}! 🌿💚\n\nAqui é a Enf. Brisa da Planta y Raiz.\n\n` +
    `🎯 *Garanta agora sua Orientação Técnica em Cannabis Medicinal com o Dr. Edilson Bezerra On por apenas R$30* — relatório em PDF com assinatura digital ICP-Brasil e selo gov.br.\n\n` +
